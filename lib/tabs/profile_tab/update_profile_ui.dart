    ...
    return BlocConsumer<UpdateProfileCubit, UpdateProfileStates>(
        listener: (context, state) {
          if (state is UpdateProfileLoading) {
            ...
            UIUtils.hideDialog(context);
            UIUtils.showToastMessage(message: "Profile Updated Successfully!",
        ...
        builder: (context, state) {
          ...
          return Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: IconButton(
                icon: Icon(
                    Icons.arrow_back_ios, color: ColorsManager.primaryOrange),
                onPressed: () => Navigator.pop(context),
              ),
              title: Text(
                'Update Profile',
                style: StylesManager.googleFont20BlackRegular.copyWith(
                    color: Colors.white),
              ),
              centerTitle: true,
            ),
